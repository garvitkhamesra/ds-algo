final class Employee {
    ...
    public Employee(String name, int age, Address address) {
        this.empName = name;
        this.age = age;
        this.address = new Address(address.addressType, address.address, address.city);
    }
...
// MainClass.java
public class ImmutableClassWithCustomObject {
    public static void main(String[] args) throws Exception {
        Address address = new Address("Home", "Madhapur", "Hyderabad");
        Employee emp = new Employee("Adithya", 34, address);
